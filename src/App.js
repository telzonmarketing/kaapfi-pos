...
const defaultMenu = [
  { id: 1, name: 'Milk Filter Coffee', price: 49, category: 'BEVERAGES', emoji: '☕' },
  { id: 2, name: 'Black Filter Coffee', price: 30, category: 'BEVERAGES', emoji: '☕' },
  { id: 3, name: 'Classic Kaapi', price: 119, category: 'BEVERAGES', emoji: '☕' },
  { id: 4, name: 'Kaapi Mocha', price: 129, category: 'BEVERAGES', emoji: '☕' },
  { id: 5, name: 'Kaapi Haze', price: 129, category: 'BEVERAGES', emoji: '☕' },
  { id: 6, name: 'Kaapi Classic Iced Filter', price: 110, category: 'BEVERAGES', emoji: '🧊' },
  { id: 7, name: 'Hazelnut Iced Filter', price: 125, category: 'BEVERAGES', emoji: '🧊' },
  { id: 8, name: 'Vanilla Iced Filter', price: 125, category: 'BEVERAGES', emoji: '🧊' },
  { id: 9, name: 'Sea Salt Caramel Latte', price: 139, category: 'BEVERAGES', emoji: '🧊' },
  { id: 10, name: 'Strawberry Iced', price: 125, category: 'BEVERAGES', emoji: '🍓' },
  { id: 11, name: 'Iced Mocha', price: 125, category: 'BEVERAGES', emoji: '☕' },
  { id: 12, name: 'Roafza Iced Latte', price: 125, category: 'BEVERAGES', emoji: '🌸' },
  { id: 13, name: 'Iced Caramel Latte', price: 125, category: 'BEVERAGES', emoji: '🧊' },
  { id: 14, name: 'Mocha Haze', price: 159, category: 'BEVERAGES', emoji: '☕' },
  { id: 15, name: 'Strawberry Iced Mocha', price: 149, category: 'BEVERAGES', emoji: '🍓' },
  { id: 16, name: 'Classic Cold Brew', price: 100, category: 'BEVERAGES', emoji: '❄️' },
  { id: 17, name: 'Cranberry Cold Brew', price: 120, category: 'BEVERAGES', emoji: '🔴' },
  { id: 18, name: 'Orange Cold Brew', price: 120, category: 'BEVERAGES', emoji: '🍊' },
  { id: 19, name: 'Ginger Ale Cold Brew', price: 120, category: 'BEVERAGES', emoji: '🫚' },
  { id: 20, name: 'Tonic Cold Brew', price: 120, category: 'BEVERAGES', emoji: '💧' },
  { id: 21, name: 'Kacha Aam Cold Brew', price: 125, category: 'BEVERAGES', emoji: '🥭' },
  { id: 22, name: 'Rose Cold Brew', price: 125, category: 'BEVERAGES', emoji: '🌹' },
  { id: 23, name: 'Roafza Cold Brew', price: 125, category: 'BEVERAGES', emoji: '🌸' },
  { id: 24, name: 'Strawberry Cold Brew', price: 130, category: 'BEVERAGES', emoji: '🍓' },
  { id: 25, name: 'Kokam Cold Brew', price: 130, category: 'BEVERAGES', emoji: '🍒' },
  { id: 26, name: 'Blue Ocean Cold Brew', price: 130, category: 'BEVERAGES', emoji: '🌊' },
  { id: 27, name: 'Vietnamese Cold Brew (with Milk)', price: 159, category: 'BEVERAGES', emoji: '☕' },
  { id: 28, name: 'Last Light', price: 159, category: 'BEVERAGES', emoji: '🌙' },
  { id: 29, name: 'Coastal Blue', price: 129, category: 'BEVERAGES', emoji: '🌊' },
  { id: 30, name: 'Berry Bloom', price: 129, category: 'BEVERAGES', emoji: '🫐' },
  { id: 31, name: 'Red Mood', price: 129, category: 'BEVERAGES', emoji: '🔴' },
  { id: 32, name: 'Chatpata Sandwich', price: 189, category: 'GOURMET SANDWICHES', emoji: '🥪', variantGroup: 'Protein', variantOptions: ['Paneer', 'Chicken'] },
  { id: 33, name: 'Barbecue Sandwich', price: 189, category: 'GOURMET SANDWICHES', emoji: '🥪', variantGroup: 'Protein', variantOptions: ['Paneer', 'Chicken'] },
  { id: 34, name: 'Makhanwala Sandwich', price: 189, category: 'GOURMET SANDWICHES', emoji: '🥪', variantGroup: 'Protein', variantOptions: ['Paneer', 'Chicken'] },
  { id: 35, name: '1996 Carolina Sandwich', price: 189, category: 'GOURMET SANDWICHES', emoji: '🥪', variantGroup: 'Protein', variantOptions: ['Paneer', 'Chicken'] },
  { id: 36, name: 'Salted Fries', price: 179, category: 'FRIES', emoji: '🍟' },
  { id: 37, name: 'Salt & Pepper Fries', price: 179, category: 'FRIES', emoji: '🍟' },
  { id: 38, name: 'Peri Peri Fries', price: 179, category: 'FRIES', emoji: '🍟' },
  { id: 39, name: 'Kolhapuri Spicy Fries', price: 179, category: 'FRIES', emoji: '🍟' },
  { id: 40, name: 'Desi Fries (Tangy & Spicy)', price: 179, category: 'FRIES', emoji: '🍟' },
  { id: 41, name: '1990s Achari Fries', price: 179, category: 'FRIES', emoji: '🍟' },
  { id: 42, name: 'Smoky Barbecue Fries', price: 179, category: 'FRIES', emoji: '🍟', modifiers: ['BBQ Sauce Dressing'] },
  { id: 43, name: '1996 Carolina Fries', price: 179, category: 'FRIES', emoji: '🍟', modifiers: ['Carolina Sauce Dressing'] },
  { id: 44, name: 'Idli with Veg Curry', price: 80, category: 'TIFFIN', emoji: '🍚' },
  { id: 45, name: 'Idli with Chicken Curry', price: 100, category: 'TIFFIN', emoji: '🍗' },
  { id: 46, name: 'Chatpata', price: 139, category: 'MALABAR PARATHA', emoji: '🫓', variantGroup: 'Protein', variantOptions: ['Paneer', 'Chicken'] },
  { id: 47, name: 'Saoji', price: 139, category: 'MALABAR PARATHA', emoji: '🫓', variantGroup: 'Protein', variantOptions: ['Paneer', 'Chicken'] },
  { id: 48, name: 'Makhanwala', price: 139, category: 'MALABAR PARATHA', emoji: '🫓', variantGroup: 'Protein', variantOptions: ['Paneer', 'Chicken'] },
  { id: 49, name: 'Achari', price: 139, category: 'MALABAR PARATHA', emoji: '🫓', variantGroup: 'Protein', variantOptions: ['Paneer', 'Chicken'] },
  { id: 50, name: 'Smokey BBQ', price: 139, category: 'MALABAR PARATHA', emoji: '🫓', variantGroup: 'Protein', variantOptions: ['Paneer', 'Chicken'] },
  { id: 51, name: 'Burnt Garlic', price: 139, category: 'MALABAR PARATHA', emoji: '🫓', variantGroup: 'Protein', variantOptions: ['Paneer', 'Chicken'] },
  { id: 52, name: '1996 Carolina', price: 139, category: 'MALABAR PARATHA', emoji: '🫓', variantGroup: 'Protein', variantOptions: ['Paneer', 'Chicken'] },
  { id: 53, name: 'Chicken Keema Irani Pav', price: 189, category: 'IRANI PAV', emoji: '🥪' },
  { id: 54, name: 'Paneer Keema Irani Pav', price: 189, category: 'IRANI PAV', emoji: '🥪' },
];
